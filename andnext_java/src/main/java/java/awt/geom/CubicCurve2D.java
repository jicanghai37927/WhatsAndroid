...
public abstract class CubicCurve2D implements Shape, Cloneable {
	 ...
	 * 
	 * @see java.awt.geom.geom.CubicCurve2D.Float
	 * @see java.awt.geom.geom.CubicCurve2D.Double
	 * @since 1.2
	 */
	 ...
	 * ready for solving against val with solveCubic. We currently have: <pre>
	 * val = P(t) = C1(1-t)^3 + 3CP1 t(1-t)^2 + 3CP2 t^2(1-t) + C2 t^3 = C1 -
	 * 3C1t + 3C1t^2 - C1t^3 + 3CP1t - 6CP1t^2 + 3CP1t^3 + 3CP2t^2 - 3CP2t^3 +
	 * C2t^3 0 = (C1 - val) + (3CP1 - 3C1) t + (3C1 - 6CP1 + 3CP2) t^2 + (C2 -
	 * 3CP2 + 3CP1 - C1) t^3 0 = C + Bt + At^2 + Dt^3 C = C1 - val B = 3*CP1 -
	 * 3*C1 A = 3*CP2 - 6*CP1 + 3*C1 D = C2 - 3*CP2 + 3*CP1 - C1 </pre>
	 */
